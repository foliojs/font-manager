...
void init(Handle<Object> exports) {
  Nan::SetMethod(exports, "getAvailableFonts", getAvailableFonts<true>);
  Nan::SetMethod(exports, "getAvailableFontsSync", getAvailableFonts<false>);
  Nan::SetMethod(exports, "findFonts", findFonts<true>);
  Nan::SetMethod(exports, "findFontsSync", findFonts<false>);
  Nan::SetMethod(exports, "findFont", findFont<true>);
  Nan::SetMethod(exports, "findFontSync", findFont<false>);
  Nan::SetMethod(exports, "substituteFont", substituteFont<true>);
  Nan::SetMethod(exports, "substituteFontSync", substituteFont<false>);
}
